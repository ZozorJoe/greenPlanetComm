<?php 
include "langues/decide-lan.php"; 

//require_once "controlleur/callback.php";
?>
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-xs-12">
            ...
            <ul class="left-info">
              ...
              <li><a href="index.php"><img src="assets/images/logo.png" width="250px" height="50px"></a></li>
          ...
          <div class="col-md-4">
            ...
            <li><a href="https://www.facebook.com/profile.php?id=100084910672276" target="_blank"><i class="fa fa-facebook"></i></a></li>

<li><a href="https://twitter.com/Greenplanetcomm" target="_blank"><i class="fa fa-twitter"></i></a></li>

<li><a href="https://www.linkedin.com/in/green-planet-communcication-05477124a" target="_blank"><i class="fa fa-linkedin"></i></a></li>
